...
class Chat:
    ...
    def janela(self):
        ...
        self.caixa_texto.place(relx=0.05, rely=0.05, width=500, height=500)

        self.envia_mensagem = Entry(self.root)
        self.envia_mensagem.place(relx=0.05, rely=0.9, width=400, height=20)

        self.btn_enviar = Button(self.root, text='Enviar', command=self.enviar_mensagem)
        self.btn_enviar.place(relx=0.8, rely=0.9, width=100, height=20)
